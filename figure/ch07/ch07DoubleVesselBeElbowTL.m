...
legend({'双容','原有单容','弯头式双容'},'Position',[0.175982818741828 0.6960621462913 0.524137921168887 0.189054721623511]);
end
if 0
figure
paperFigureSet('small',6);
...
xlabel('频率(Hz)','FontSize',10);
ylabel( '透射系数','FontSize',10);
h=legend({'弯头式双容'},'Position',[0.175982818741828 0.6960621462913 0.524137921168887 0.189054721623511]);  
set(h,'box','off')
end
...
ylabel( '透射系数','FontSize',10);
%ylabel( '20lg(t_I)','FontSize',10);
h=legend({'双容','弯头式双容'},'Position',[0.175982818741828 0.6960621462913 0.524137921168887 0.189054721623511]);  
set(h,'box','off')
end
end
