...
for plotCount = 1:length(expDataCombineStruct)
    ...
    if 1 == length(expDataCombineStruct)
        ...
        ,'Marker',getMarkStyle(plotCount+1),'LineStyle',getLineStyle(plotCount));
        ...
        ,'Marker',getMarkStyle(plotCount),'LineStyle',getLineStyle(plotCount));
    ...
    if strcmp(errorType,'none')
        fh.plotHandle(plotCount) = plot(x,y,'color',getPlotColor(plotCount)...
            ,'Marker','o'...
            ,'MarkerSize',2 ...
            ,'MarkerEdgeColor',getPlotColor(plotCount)...
            ,'MarkerFaceColor',getPlotColor(plotCount));
    else
...
if showMeasurePoint
    fh.textboxMeasurePoint = annotation('textbox',...
        [0.147288812785388 0.907048611111112 0.770719971987672 0.0911999999999999],...
        'String',xTopText,...
        'FaceAlpha',0,...
        'EdgeColor','none'...
