...
isFixRang = false;%是否强制限定两个图的colorbar的显示范围
...
if 1==length(dataCells)
    ...
    if isempty(xSection)
        ...
        fh.lowText = annotation('textbox',...
            ...
            ,'FontName',fontName...
            ,'FontSize',paperFontSize());
        fh.heighText = annotation('textbox',...
        ...
        if ~isempty(xlabelValue)
            xlabel(xlabelValue,'FontName',fontName...
                              ,'FontSize',paperFontSize());
        end
        if ~isempty(ylabelValue)
            ylabel(ylabelValue,'FontName',fontName...
                              ,'FontSize',paperFontSize());
        end
        subplot(1,2,2);
        count = 1;
    ...
    for plotCount = 1:length(dataCells)
        ...
        if ~isempty(xlabelValue)
            xlabel(xlabelValue{plotCount},'FontName',fontName...
                                        ,'FontSize',paperFontSize());
        end
        if ~isempty(ylabelValue)
            ylabel(ylabelValue{plotCount},'FontName',fontName...
                                        ,'FontSize',paperFontSize());
        end
    end
    if ~isempty(xSection)
