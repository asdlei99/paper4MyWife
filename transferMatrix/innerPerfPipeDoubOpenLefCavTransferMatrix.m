function M = innerPerfPipeDoubOpenLefCavTransferMatrix(n1,dp1,Din,Dv,lp1,lc,la1,la2,varargin)
...
[Ta8,Tb8,Tc8,Td8] = calcT1(n1,dp1,Din,Dv,la1,la2,lp1,k,M1,M2,R0,lc);
...
function [Ta8,Tb8,Tc8,Td8] = calcT1(n1,dp1,Din,Dv,la1,la2,lp1,k,M1,M2,R0,lc)
% n1 孔管穿孔数
% dp 孔管穿孔孔径
% Din 穿管管径
% lp1 穿孔部分长度
