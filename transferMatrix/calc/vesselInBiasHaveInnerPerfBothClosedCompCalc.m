function [pressure1,pressure2] = vesselInBiasHaveInnerPerfBothClosedCompCalc(massFlowE,Frequency,time ...
    ,L1,L2,Dpipe,Dv,l,Lv1,Lv2,lc,dp1,dp2,lp1,lp2,n1,n2,la1,la2,lb1,lb2,Din,Dex,Dbias,lv1,lv4,xSection1,xSection2...
...
for i = 1:length(Frequency)
    ...
    matrix_Mv{count} = vesselIBHaveInnerPerfBothClosedCompTransferMatrix(Dpipe,Dv,l,Lv1,Lv2...
