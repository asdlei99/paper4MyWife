function [pressure1,pressure2,pressure3] = doubleVesselElbowPerfInOpenOutClosePulsationCalc(massFlowE,Frequency,time ...
,L1,L2,L3,LV1,LV2,Lv1,Lv2,l,Dpipe,DV1,DV2,lv3,Dbias,dp,lc,sectionL1,sectionL2,sectionL3,varargin)
...
for i = 1:length(Frequency)
    ...
    matrix_Mv2{count} = vesselStraightFrontBiasHelmTransferMatrix(LV2,Lv1,Lv2,l,lv3,Dbias,dp,lc ...
