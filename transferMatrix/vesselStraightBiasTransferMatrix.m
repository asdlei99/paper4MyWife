function [M,k] = vesselStraightBiasTransferMatrix(Lv,l,lv2,Dbias,varargin )
%缓冲罐入口顺接，出口错位的气流脉动计算
...
Mv = vesselMatrix_StrBias(isUseStaightPipe,Lv,lv2,k,Dvessel,Dpipe,Dbias,a,optDamp,optMachVessel);
%后管道传递矩阵
...
function Mv = vesselMatrix_StrBias(isUseStaightPipe,Lv,lv2,k,Dv,Dpipe,Dbias,a,optDamping,optMach)
