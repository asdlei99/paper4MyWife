...
param.isOpening = 0;
Lv1 = [param.LBias:0.05:0.9];
useBiasVessel = true;
isFast = false;
if 0 == nargin
    orificD = param.Dpipe*0.5;
end
while length(pp)>=2
    prop =pp{1};
    val=pp{2};
...
for i = 1:length(Lv1)
    ...
    if useBiasVessel
        [pressure1,pressure2] = vesselBiasHaveOrificePulsationCalc(param.massFlowE,param.fre,time...
            ...
            ,orificD,param.LBias,param.sectionL1,param.sectionL2...
        ...
        [pressure1,pressure2] = ...
            vesselHaveOrificePulsationCalc(param.massFlowE,param.fre,time...
            ,param.L1,param.L2,param.Lv1,param.Lv2,param.l,param.Dpipe,param.Dv,param.Dv...
            ,orificD,param.sectionL1,param.sectionL2...
            ,'a',param.acousticVelocity...
            ,'isDamping',param.isDamping...
            ,'friction',param.coeffFriction...
            ,'meanFlowVelocity',param.meanFlowVelocity...
    ...
    if isFast
        theoryDataCells{i}.puls = calcPuls(pressure,dcpss);
        theoryDataCells{i}.x = x;
        theoryDataCells{i}.Lv1 = Lv1(i);
    else
