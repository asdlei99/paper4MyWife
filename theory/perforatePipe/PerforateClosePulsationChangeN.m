function theoryDataCells = PerforateClosePulsationChangeN(param,rangN,varargin)
pp = varargin;
%% 内插管的气流脉动-改变开孔数
...
param.Lout = param.lb1 + param.lp2+ param.lb2;%鍐呮彃绠″叆鍙ｆ?甸暱搴?
param.bp1 = calcPerforatingRatios(param.n1,param.dp1,param.Din,param.lp1);
param.bp2 = calcPerforatingRatios(param.n2,param.dp2,param.Din,param.lp2);
param.Lin  = param.la1 + param.lp1+ param.la2;%鍐呮彃绠″叆鍙ｆ?甸暱搴?
param.LBias = (0.150+0.168);%232
param.Dbias = 0;%鏃犲唴鎻掔??
